...
const cameraStreams = [
  {
    id: "cam1",
    rtspUrl: `rtsp://admin:${process.env.CAMERA_PASS}@192.168.1.22:554/h265Preview_01_main`,
    outputPath: "./cams/cam1-videos/index.m3u8",
  },
...
cameraStreams.forEach((stream) =>
  startFFmpegProcess(stream.rtspUrl, stream.outputPath)
);
